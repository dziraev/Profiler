        ...
        {input.value && (
          ...
          >
            {showPassword ? (
              ...
              >
                <path
                  d='M5 7.27L6.28 6L23 22.72L21.73 24L18.65 20.92C17.5 21.3 16.28 21.5 15 21.5C10 21.5 5.73 18.39 4 14C4.69 12.24 5.79 10.69 7.19 9.46L5 7.27ZM15 11C15.7956 11 16.5587 11.3161 17.1213 11.8787C17.6839 12.4413 18 13.2044 18 14C18.0005 14.3406 17.943 14.6787 17.83 15L14 11.17C14.3213 11.057 14.6594 10.9995 15 11M15 6.5C20 6.5 24.27 9.61 26 14C25.1839 16.0732 23.7969 17.8727 22 19.19L20.58 17.76C21.9629 16.8034 23.0782 15.5091 23.82 14C23.0116 12.3499 21.7564 10.9598 20.1973 9.9875C18.6381 9.01524 16.8375 8.49988 15 8.5C13.91 8.5 12.84 8.68 11.84 9L10.3 7.47C11.74 6.85 13.33 6.5 15 6.5ZM6.18 14C6.98844 15.6501 8.24357 17.0402 9.80273 18.0125C11.3619 18.9848 13.1625 19.5001 15 19.5C15.69 19.5 16.37 19.43 17 19.29L14.72 17C14.0242 16.9254 13.3748 16.6149 12.88 16.12C12.3851 15.6252 12.0746 14.9758 12 14.28L8.6 10.87C7.61 11.72 6.78 12.78 6.18 14V14Z'
                  fill='#407BFF'
                />
              </svg>
            ) : (
              ...
              >
                <path
                  d='M15 12.5C15.7956 12.5 16.5587 12.8161 17.1213 13.3787C17.6839 13.9413 18 14.7044 18 15.5C18 16.2956 17.6839 17.0587 17.1213 17.6213C16.5587 18.1839 15.7956 18.5 15 18.5C14.2044 18.5 13.4413 18.1839 12.8787 17.6213C12.3161 17.0587 12 16.2956 12 15.5C12 14.7044 12.3161 13.9413 12.8787 13.3787C13.4413 12.8161 14.2044 12.5 15 12.5M15 8C20 8 24.27 11.11 26 15.5C24.27 19.89 20 23 15 23C10 23 5.73 19.89 4 15.5C5.73 11.11 10 8 15 8ZM6.18 15.5C6.98825 17.1503 8.24331 18.5407 9.80248 19.5133C11.3617 20.4858 13.1624 21.0013 15 21.0013C16.8376 21.0013 18.6383 20.4858 20.1975 19.5133C21.7567 18.5407 23.0117 17.1503 23.82 15.5C23.0117 13.8497 21.7567 12.4593 20.1975 11.4867C18.6383 10.5142 16.8376 9.99868 15 9.99868C13.1624 9.99868 11.3617 10.5142 9.80248 11.4867C8.24331 12.4593 6.98825 13.8497 6.18 15.5V15.5Z'
                  fill='#407BFF'
                />
              </svg>
            )}
