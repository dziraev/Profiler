...
const PhotoCV = ({ tabIndex = 0 , ...props }) => {
    ...
    <>
      {!image && !isLoading && (
        <div
          ...
          onKeyDown={(e) => e.code === 'Enter' && dispatch(openPhotoModal())}
        >
          <div className={styles.photo__button}>
            ...
            >
              <path
                d='M8.55599 1.48134C8.55599 1.17451 8.30726 0.925781 8.00043 0.925781C7.69361 0.925781 7.44488 1.17451 7.44488 1.48134V7.44434H1.48134C1.17451 7.44434 0.925781 7.69307 0.925781 7.99989C0.925781 8.30672 1.17451 8.55545 1.48134 8.55545H7.44488V14.5184C7.44488 14.8252 7.69361 15.0739 8.00043 15.0739C8.30726 15.0739 8.55599 14.8252 8.55599 14.5184V8.55545H14.5184C14.8252 8.55545 15.0739 8.30672 15.0739 7.99989C15.0739 7.69307 14.8252 7.44434 14.5184 7.44434H8.55599V1.48134Z'
                fill='#407BFF'
              />
            </svg>
          </div>
      ...
      {image && !isLoading && (
        ...
        >
          ...
          <div
            className={styles.photo__image__change}
            onClick={() => dispatch(openPhotoModal())}
          >
            <svg
              width='16'
